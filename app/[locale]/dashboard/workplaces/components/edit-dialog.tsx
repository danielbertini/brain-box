...
const WorkplacesEditDialog: React.FC<Props> = ({ id, mutate }) => {
  ...
  const loadData = useCallback(async () => {
    ...
    const response = await fetch(`/api/workplaces/get?id=${id}`, {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const response = await fetch("/api/workplaces/edit", {
      method: "POST",
      headers: { "Accept-Language": locale },
      body: JSON.stringify({
        id: id,
...
export default WorkplacesEditDialog;
